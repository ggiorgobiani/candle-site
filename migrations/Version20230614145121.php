 ...
 */
final class Version20230614145121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_product (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, register_date DATETIME NOT NULL, amount INT NOT NULL, INDEX IDX_2530ADE6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(40) NOT NULL, lastname VARCHAR(40) NOT NULL, phone VARCHAR(40) NOT NULL, street VARCHAR(40) NOT NULL, street_number VARCHAR(40) NOT NULL, zip VARCHAR(40) NOT NULL, city VARCHAR(40) NOT NULL, country VARCHAR(40) NOT NULL, connections_counter INT NOT NULL, register_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_login_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
